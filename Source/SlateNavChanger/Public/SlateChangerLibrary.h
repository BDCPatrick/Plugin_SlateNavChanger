...
struct FSlateNavigationKeys
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Slate Navigation")
	FKey Up;
 ...
 */
UCLASS()
class SLATENAVCHANGER_API USlateChangerLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Slate Navigation")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Slate Navigation")
